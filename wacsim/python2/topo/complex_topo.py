...
class ComplexTopo(Topo):
    ...
    def setup_network_for_node(self, net, node_data, provider_router):
        ...
        node.cmd('sysctl -w net.ipv4.conf.{intf}.accept_redirects=1'.format(intf=node_data['interface']))
        node.cmd('sysctl -w net.ipv4.conf.{intf}.secure_redirects=0'.format(intf=node_data['interface']))
