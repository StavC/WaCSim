...
class AttackerControl(NodeControl):
    ...
    def start_attack(self):
        ...
        elif self.this_attacker_data['type'] == 'seq_mitm':
            generic_plc_path = Path(__file__).parent.parent.absolute() / "network_attacks" / "Seq_mitm_attack.py"
        elif self.this_attacker_data['type'] == 'rogue_scada':
            generic_plc_path = Path(__file__).parent.parent.absolute() / "network_attacks" / "rogue_scada_attack.py"
        elif self.this_attacker_data['type'] == 'noise_injection':
            generic_plc_path = Path(__file__).parent.parent.absolute() / "network_attacks" / "noise_injection_attack.py"
        elif self.this_attacker_data['type'] == 'tcp_rst':
            generic_plc_path = Path(__file__).parent.parent.absolute() / "network_attacks" / "tcp_rst_attack.py"
        elif self.this_attacker_data['type'] == 'icmp_redirect_mitm':
            generic_plc_path = Path(__file__).parent.parent.absolute() / "network_attacks" / "icmp_redirect_mitm_attack.py"
        else:
