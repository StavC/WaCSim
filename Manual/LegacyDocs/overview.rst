...
WaCSim, originally developed by SUTD Critical Infrastructure Systems Lab, TU Delft Department of Water Management, CISPA, and iTrust, serves as a tool for simulating the cyber
...
WaCSim adds some key additions that enable more complex behavior in the model, as well as a few quality-of-life changes. Primarily, WaCSim enables the usage of custom logic
...
WaCSim is capable of the following:
...
This is not an exhaustive list of all that WaCSim is capable of. To learn more about WaCSim's capabilities refer to the `Examples`_ and `Config Documentation`_ portions of the documentation.
...
.. _`developing`: https://github.com/Critical-Infrastructure-Systems-Lab/WaCSim/blob/master/Manual/LegacyDocs/developing.rst
