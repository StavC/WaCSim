#!/usr/bin/env python3
"""
Pump Speed Control Algorithm for P1
====================================

This algorithm demonstrates variable speed pump control using WaCSim's
custom algorithm feature. Instead of simple on/off control, this algorithm
returns a numeric speed value between 0.0 and 2.0.
