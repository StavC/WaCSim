...
3.051	0	0	1
3.051	0	0	1
3.19157783574666	-131.25343723118	55.4107038522739	1
"""
    ...
    if csv_content['T41'].iloc[-1:].values[0] >=10.0:
        if csv_content['J21'].iloc[-1:].values[0] <=56.0:
            print(f'J21 value is less than 50, meaning that the pump is off hence we can open the valve')
            return 'open',True
        else:
